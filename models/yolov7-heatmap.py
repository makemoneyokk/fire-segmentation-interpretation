...
def get_params():
    params = {
        'weight': 'D:/data(teacher)/paper-code/YOLOv7-Pytorch-Segmentation/YOLOv7-Pytorch-Segmentation/runs/train-seg/exp99/weights/best.pt',
        'device': 'cuda:0',
        'method': 'XGradCAM',
...
if __name__ == '__main__':
    ...
    model(r'D:/data(teacher)/paper-code/YOLOv7-Pytorch-Segmentation/YOLOv7-Pytorch-Segmentation/runs/predict-seg/exp67/10.55.50.jpg', 'D:/data(teacher)/paper-code/YOLOv7-Pytorch-Segmentation/YOLOv7-Pytorch-Segmentation/result')
