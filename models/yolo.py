...
from models.cspcm import CSPCM
from models.MHSA import MHSA
from models.odconv import ODConv2d
from models.mobilevitv2 import MobileViTBv2
from models.mobilevitv3 import MobileViTBv3
from models.MobileViTAttention import MobileViTAttention
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in {
                ...
                DSConv2D, EVCBlock, PConv, CoordConv, RepC3, C3RFEM, Conv2Formers, RepNCSPELAN4, C3_Faster,
                C3_DBB, CAM, CSPStage, AIFI, attention_model, ScalSeq, Zoom_cat, Add, ASPP, C3_Res2Block, CSPCM,
                DiverseBranchBlock, MHSA, ODConv2d, SAConv2d, MobileViTBv2, MobileViTBv3, MobileViTAttention, SE,
                CBAM}:
            c1, c2 = ch[f], args[0]
            ...
            args = [c1, c2, *args[1:]]
            if m in {BottleneckCSP, C3, C3TR, C3Ghost, C3x, SPPCSPC, C3_Faster, CSPStage}:
