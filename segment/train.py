...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default=ROOT / 'models/yolov7-seg.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='D:/data(teacher)/paper-code/YOLOv7-Pytorch-Segmentation_1/YOLOv7-Pytorch-Segmentation/data/yolov7-tiny-CBAMC.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/datafire.yaml', help='dataset.yaml path')
